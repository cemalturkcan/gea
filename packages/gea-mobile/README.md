...
[![npm version](https://badge.fury.io/js/%40geajs%2Fmobile.svg)](https://www.npmjs.com/package/@geajs/mobile)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/dashersw/gea/blob/master/LICENSE)

Mobile-oriented UI primitives for the [Gea](https://www.npmjs.com/package/@geajs/core) framework — full-screen views, iOS-style navigation transitions, back gestures, sidebars, tabs, pull-to-refresh, and infinite scroll.
