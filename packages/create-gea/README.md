...
Scaffold a new [Gea](https://www.npmjs.com/package/@geajs/core) app with Vite in seconds.
...
- **[@geajs/vite-plugin](https://www.npmjs.com/package/@geajs/vite-plugin)** — Vite plugin
