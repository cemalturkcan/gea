...
The Gea router infers types from your route config. No codegen, no manual type definitions. The route object is the single source of truth.
...
```ts
import type { ExtractParams } from '@geajs/core'
